...
imgdir="$HOME/.config/eww/hosf/images"
lastimg="none"
...
while true; do
	...
	then
		...
		title_parsed=`$HOME/.config/eww/hosf/scripts/parse_jp.py "$title"`
		...
		artist_parsed=`$HOME/.config/eww/hosf/scripts/parse_jp.py "$artist"`
